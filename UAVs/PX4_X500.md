...
source install/setup.bash
ros2 launch cpsl_ros2_sensors_bringup uav_sensor_bringup.launch.py lidar_enable:=true lidar_scan_enable:=true camera_enable:=true radar_enable:=false platform_description_enable:=true rviz:=false namespace:=cpsl_uav_1
```
